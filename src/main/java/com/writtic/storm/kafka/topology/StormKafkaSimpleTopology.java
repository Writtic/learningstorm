package com.writtic.storm.kafka.topology;
...
import com.writtic.storm.kafka.bolt.ClassifyKeyBolt;
import com.writtic.storm.kafka.bolt.CutLogBolt;
import com.writtic.storm.kafka.bolt.DoctypeCountBolt;
...
public class StormKafkaSimpleTopology {
	...
	public static void main(String[] args) throws Exception {
		...
		String brokerUrl = "192.168.99.100:9092";	// broker(kafka) url
